    ...
    <div className="space-y-5 max-w-6xl mx-auto">
      ...
      <div className="flex flex-wrap items-center gap-2.5 no-print">
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white hover:bg-slate-50 text-emerald-700 text-xs font-bold border border-emerald-600 shadow-xs transition-colors"
        >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white hover:bg-slate-50 text-slate-700 text-xs font-bold border border-slate-200 shadow-xs transition-colors"
        >
          ...
          <div className="w-full max-w-xl rounded-2xl bg-white p-6 shadow-2xl border border-slate-200 flex flex-col max-h-[90vh]">
            ...
            <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-bold shadow-xs transition-colors"
              >
                ...
                {adicionandoEnfModal ? (
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-1.5 rounded-xl border border-emerald-500 text-xs text-slate-900 focus:outline-none"
                      onKeyDown={(e) => {
                        if (e.key === "Enter") {
                    ...
                    <button
                      ...
                      className="px-2.5 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-500 text-xs"
                    >
                      <X className="w-4 h-4" />
                    </button>
                  </div>
